...
\begin{multicols*}{2}
	...
	\begin{enumerate}[label=(\alph*)]
		\item Outline:
		      ...
		      We have that $f$ is Harmonic on $V\setminus\set{a,z}$, while $f(a),f(z)\in\RR$ are free, this is an instance of the discrete Dirchlet problem, and so there is a unique solution $f$.
